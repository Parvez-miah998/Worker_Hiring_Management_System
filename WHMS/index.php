...
if (isset($_POST['login'])) {
      ...
      if ($user) {
        ...
        echo '<div class="alert alert-danger" style = " max-width: 600px; margin: 0 auto; padding: 0px;border-radius: 5px; text-align: center; color: yellow;font-size:25px">Email Does Not Exist !</div>';
      }
    }
?>
...
<head>
  ...
  <title>Worker Hiring Management System || Login Page</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
</head>

<body style=" padding: 50px; background-image: url(admin/images/layout_img/login_image.jpg); background-size: cover">
   <div class="container" style=" max-width: 600px; margin: 0 auto; padding: 50px;border-radius: 15px;">
    ...
    <h3 style="text-align: center; color: black;font-family: Lucida Calligraphy">Login</h3> <br>
    ...
    <form action="index.php" method="post">
      ...
      <br>
      <div class="form-btn">
        <a class="form-btn" href="registration.php">Signup</a>
      </div>
