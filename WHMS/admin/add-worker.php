...
$query->bindParam(':idproof',$idproof,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Worker detail has been added.")</script>';
echo "<script>window.location.href ='add-worker.php'</script>";
  }
  else
    {
...
<html lang="en">
   <head>
      <title>Worker Hirirng Management System || Add Worker</title>
                  ...
                  <div class="container-fluid">
                     ...
                     <div class="row column8 graph">
                        ...
                        <fieldset>
                           ...
                           <div class="field">
                              <label class="label_field">Worker ID</label>
                           ...
                           <div class="field">
                              <label class="label_field">Service Category Name</label>
 ...
 <?php } ?>
                        ...
                        <!--    <br>
                          ...
                          <br>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Worker Picture</label>
