...
<html lang="en">
   <head>
      ...
      <title>Worker Hiring Management System || Forgot Page</title>
...
return true;
   ...
   <body class="inner_page login" style="font-family: Candara">
            ...
            <div class="center verticle_center full_height">
               <div class="login_section">
                  <div class="logo_login">
                     <div class="center">
                        <h3 style="color: white;">Worker Hiring Management System</h3>
                     </div>
                  </div>
