...
<html lang="en">
   <head>
      ...
      <title>Worker Hiring Management System||Dashboard</title>
   ...
   <body class="dashboard dashboard_1" style="font-family: Candara">
...
?>
                                    ...
                                    <p class="head_couter">Service Category<br /><br />
...
?>
                                   <p class="total_no"><?php echo htmlentities($totmaid);?></p>
                                    <p class="head_couter">Listed Workers<br /><br />
                                       <a href="manage-worker.php" class="btn btn-primary btn-sm">View Details</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
...
?>
                                   <p class="total_no"><?php echo htmlentities($newreq);?></p>
                                    <p class="head_couter">Hire Request<br /><br />
...
?>
                                   <p class="total_no"><?php echo htmlentities($assreq);?></p>
                                    <p class="head_couter">Approved Request<br /><br />
...
?>
                                   <p class="total_no"><?php echo htmlentities($totreq);?></p>
                                    <p class="head_couter">Total Hire Request<br /><br /><br />
...
?>
                                   <p class="total_no"><?php echo htmlentities($canreq);?></p>
                                    <p class="head_couter">Supervisor Details <br /><br />
<br>
                                       <a href="supervisordetails.php" class="btn btn-primary btn-sm">View Details</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
...
?>
                                   <p class="total_no"><?php echo htmlentities($totreq);?></p>
                                    <p class="head_couter">Total User Details<br /><br /><br />
                                       <a href="user-manage.php" class="btn btn-primary btn-sm">View Details</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
