...
$query->execute();
 echo '<script>alert("Worker detail has been updated")</script>';
}
?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <title>Worker Hirirng Management System || Update Worker Details</title>
 ...
 <?php } ?>
                        ...
                        <!--   <div class="field">
                          ...
                          <br>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Worker Pic</label>
