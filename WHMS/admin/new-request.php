...
<html lang="en">
   <head>
      ...
      <title>Worker Hiring Management System || New Request</title>
                                 ...
                                 <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                     ...
                                     <!--   <th class="d-none d-sm-table-cell">Booking Date</th>-->
                                       ...
                                       <tbody>
                                          <?php
$sql="SELECT * from tblmaidbooking where Status is null ORDER BY Status DESC, BookingDate DESC";
...
{               ?>
                                        ...
                                        <td class="font-w600"><?php  echo htmlentities($row->Address);?></td>
                                       <!-- <td class="font-w600">
                                            <span class="badge badge-primary"><?php  echo htmlentities($row->BookingDate);?></span>
                                        </td> -->
                                        <td class="font-w600"><?php  echo htmlentities($row->Notes);?></td>
                                        <?php if($row->Status==""){ ?>
