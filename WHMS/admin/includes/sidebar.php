...
{               ?>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="user-manage.php"><i class="fa fa-users golden_color"></i> <span>User Details</span></a></li>
                     <li class="active">
                        <a href="#doller_page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-clock-o orange_color"></i> <span>Supervisor</span></a>
                        <ul class="collapse list-unstyled" id="doller_page">
                           <li>
                              <a href="s-registration.php">> <span>Add Supervisor</span></a>
                           </li>
                           <li>
                              <a href="supervisordetails.php">> <span>Supervisor Details</span></a>
                           </li>
                        </ul>
                     </li>
                     <li class="active">
                     ...
                     <li>
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-users purple_color"></i> <span>Worker</span></a>
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="add-worker.php">> <span>Add Worker</span></a></li>
                           <li><a href="manage-worker.php">> <span>Manage Worker</span></a></li>
                     ...
                     <li class="active">
                        <a href="#additional_page1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-clone red_color"></i> <span> Search</span></a>
                        <ul class="collapse list-unstyled" id="additional_page1">
                           <li>
                              <a href="search-booking-request.php">> <span>Booking Request</span></a>
                           </li>
                           <li>
                              <a href="search-worker.php">> <span>Search Worker</span></a>
                           </li>
