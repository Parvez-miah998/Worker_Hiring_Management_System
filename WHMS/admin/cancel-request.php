...
<html lang="en">
   <head>
      ...
      <title>Worker Hiring Management System || Cancell Request</title>
                              ...
                              <div class="table_section padding_infor_info">
                                 <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          <?php
$sql="SELECT * from tblmaidbooking where Status='Cancelled' ORDER BY Status DESC, BookingDate DESC";
